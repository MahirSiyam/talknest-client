  ...
  <div className="card bg-base-100 w-full max-w-sm shadow-2xl border border-gray-100">
    <div className="card-body">
      ...
      <form onSubmit={handleRegister} className="space-y-3">
        ...
        <button className="btn btn-neutral bg-[#117a65] text-white w-full">Register</button>

        <button type="button" className="btn bg-white text-black border-[#e5e5e5] w-full flex items-center justify-center gap-2">
        ...
        <p className="text-center font-bold pt-5">
          ...
          <Link to="/auth/logIn" className="text-[#109d81]">Login</Link>
        </p>
      </form>
    </div>
  </div>
